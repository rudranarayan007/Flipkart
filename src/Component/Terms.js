...
function Terms() {
 ...
 <div className='para'> 
     <p>
     MOST SEARCHED FOR ON FLIPKART: Electronics Store | OPPO A16K | Vivo Y33T | OPPO Reno7 5G | Bathroom Exhaust Fan | Samsung Window AC | OPPO Reno7 Pro 5G | iPhone 13 | iPhone 13 Pro | iPhone 13 Pro Max | iPhone 13 Mini | Flipkart QuickBooks | Flipkart <br/> Help Centre | Boat 2022 Store | Flipkart Track Orders | Flipkart Manage Orders | Flipkart Return Orders | Flipkart Gift Cards Store | Flipkart Axis Bank  Credit Card | Flipkart Pay Later <br/> 
MOBILES: iPhone 12 64GB | iPhone 12 Pro 512GB | iPhone 12 128GB | Vivo Y91i | Vivo Y11 | Vivo Y15 | Vivo Y50 | Vivo Y12 | Reno2 F | Oppo A12 | Oppo F15 | Oppo A31 | Samsung A71 | Samsung A5 | 1Samsung A31 | Realme X2i | Phone 11 | iPhone 11 Pro | iPhone 11 Pro Max | <br/> Mobile Offers | iphone x4G | Mobile | Nokia Mobile | Samsung Mobile | iphone | Oppo Mobile | Vivo Mobile <br/> 
CAMERA: GoPro Action Camera | Nikon Camera | Canon Camera | Sony Camera | Canon DSLR | Nikon DSLR <br/> 
LAPTOPS:ASUS Celeron Dual Core | Realme Book Prime Core i5 11th Gen | Microsoft Surface Go Pentium 128GB | Branded Laptops | Apple Laptops | Acer Laptops |Lenovo Laptops | Dell Laptops | Asus Laptops | HP Laptops | Gaming Laptops2 in 1 Laptops | Business <br/>  Laptops | Laptops | Dell latest laptops 2022 | HP latest laptops 2022 <br/> 
TVS:Nokia TV | Panasonic TV | Thomson TV | Vu TV | Realme TV | Motorola TV | OnePlus TV | sLG TV | Sony TV | Samsung TV | Android Television Iffalcon TvMi TV <br/> 
LARGE APPLIANCES:TelevisionWashing MachinesRefrigeratorsAir ConditionersElectric CookersElectric Jug(Heater) / Travel KettlesInduction CooktopsInverters / stabilizerIrons / Iron BoxMixer Grinder JuicerWet GrindersChimneysMicrowave <br/>  OvensVacuum CleanersWater PurifierFan <br/> 
CLOTHING:Men ShirtsKurta PajamaKurtasMen T-ShirtsJeansSareeDressesKids DressesDesigner Salwar SuitsBraDesigner KurtisTrack PantMen KurtasGym WearParty DressesPalazzo SuitsBoys ClothingGlovesNightyMaxi <br/>  DressesAnarkaliGownsCulottesSalwar SuitsKurtisDesigner SareesLeggingsShortsGeorgette SareesEthnic WearBriefs & Trunks <br/> 
FOOTWEAR:ShoesAdidas ShoesReebok ShoesNike ShoesPuma ShoesBootsBata ShoesWoodland ShoesSkechers ShoesSneakersWomens BootsSports ShoesLoafersSandalsLotto Sports ShoesCasual ShoesWomens Skechers Shoes | Asics <br/>  Sports ShoesFormal ShoesSchool Shoes <br/> 
GROCERIES:PhonePe Grocery VoucherHand WashSoapCashew NutsSunflower OilEggsToilet CleanerHarpic Toilet CleanerDettol SoapMustard OilBiscuitsCheesePatanjali AttaFortune OilAashirvaad Atta | Tea <br/> 
BEST SELLING ON FLIPKART:Samsung Inverter AC1.5 Ton Split ACWindow AC 1.5 TonGodrej Double Door FridgeHaier Fridge Double DoorBagsSamsung Galaxy Tab S7+BooksToysCandlesHelmetsWall Clocks | Baby <br/>  FoodChocolatesCyclesCalculatorsLipsticksMaskFastrack WatchesWalletsEarringsGold CoinsRealme Pad MiniHandbagsDIZO Watch SHurricane BSW034Wings Smartwatch <br/> 
FURNITURE:Grand Furniture SaleFurnitureSofasBedsDining setsWardrobesMattressesTV UnitsTablesChairsShelvesBean BagsOffice ChairsComputer TableOffice TablesRed Sofa Wakefit BedsWhite SofaWakefit MattressGreen SofaBlack SofaBrown Sofa <br/> 
BGMH:ToysRusDabur VitaToys StoreBooks StoreMusical Instrument StoreEnergy DrinksMilk Drink MixesProtein Supplements <br/> 
     </p>
 </div>
...
Check out https://www.flipkart.com/plus/all-offers for the entire list. Terms and conditions apply. <br/> </p>
...
<p> Get an instant discount on the phone that you have been eyeing on. Exchange your old mobile for a new one after the Flipkart experts calculate the value of your old phone, provided it is in a working condition without damage to the screen. If a phone is applicable for an exchange offer, you will see the 'Buy with Exchange' option on the product description of the phone. So, be smart, always opt for an exchange wherever possible. Terms and conditions apply.</p>
 <h4> What Can You Buy From Flipkart? <br/>
Mobile Phones</h4>
